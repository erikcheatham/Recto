...
public interface IBootloaderClient
{
    ...
    /// </summary>
    /// <summary>
    /// <c>GET /v0.4/attest?nonce=</c> (2026-09-16): ask the bootloader to
    /// sign a phone-chosen nonce with its own key. Verify the result with
    /// <see cref="BootloaderAttestation.Verify"/>; a transport success is
    /// not a verified identity.
    /// </summary>
    Task<Result<AttestResponse>> AttestAsync(
